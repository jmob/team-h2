...
public class pnlAuftrag extends javax.swing.JPanel {
  ...
  private Font smallBold = new Font(Font.FontFamily.TIMES_ROMAN, 12,
    ...
    try {
			FILE = "C:/Users/" + System.getProperty("user.name") + "/Documents/Angebot_" + getNummer() + ".pdf";
      ...
      e.printStackTrace();
			...
			try {
			FILE = "C:/Users/" + System.getProperty("user.name") + "/Documents/Auftragsbestaetigung_" + getNummer() + ".pdf";
      
      PdfWriter.getInstance(document, new FileOutputStream(FILE));
      document.open();
      addMetaData(document);
      addAuftragsbestaetigung(document);
      addContent(document);
      document.close();
    } catch (Exception e) {
      e.printStackTrace();
			...
			try {
			FILE = "C:/Users/" + System.getProperty("user.name") + "/Documents/Rechnung_" + getNummer() + ".pdf";
      
      PdfWriter.getInstance(document, new FileOutputStream(FILE));
      document.open();
      addMetaData(document);
      addRechnung(document);
      addContent(document);
      document.close();
    } catch (Exception e) {
      e.printStackTrace();
  ...
  private void addAngebot(Document document)
      throws DocumentException {
    Paragraph preface = new Paragraph();
    // We add one empty line
    addEmptyLine(preface, 1);
    // Lets write a big header
    preface.add(new Paragraph("Angebot", catFont));

    addEmptyLine(preface, 1);
    // Will create: Report generated by: _name, _date
    preface.add(new Paragraph("Angebot erzeugt von: " + System.getProperty("user.name") + ", am " + new Date(), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        smallBold));
    addEmptyLine(preface, 2);
    preface.add(new Paragraph("Dies ist ein Angebot für "+ getName1()+ " "+ getName2() + " mit der Auftragsnummer " + getNummer(), smallBold));

    addEmptyLine(preface, 1);

    
    preface.add(new Paragraph("Wohnhaft in: "+ getStrasse()+", "+ getOrt(),
        smallBold));
		addEmptyLine(preface, 1);
		 
    // Lets write a big header
    preface.add(new Paragraph("Flugdaten", catFont));
		addEmptyLine(preface, 1);
		preface.add(new Paragraph("Anzahl der Personen: "+getPersonen(), smallBold));
		  preface.add(new Paragraph("Gewählte Flightcrew: "+getFlightcrew(), smallBold));
			 preface.add(new Paragraph("Gewählte Cabincrew: "+getCabincrew(), smallBold));
			 preface.add(new Paragraph("Kosten: "+getBrutto() +" inkl. MwSt.", smallBold));
		addEmptyLine(preface, 1);
    ...
    PdfPCell c1 = new PdfPCell(new Phrase("Von"));
    c1.setHorizontalAlignment(Element.ALIGN_CENTER);
    table.addCell(c1);

    c1 = new PdfPCell(new Phrase("Nach"));
    c1.setHorizontalAlignment(Element.ALIGN_CENTER);
    table.addCell(c1);

    c1 = new PdfPCell(new Phrase("Am"));
    c1.setHorizontalAlignment(Element.ALIGN_CENTER);
    table.addCell(c1);
		c1 = new PdfPCell(new Phrase("Bis"));
    c1.setHorizontalAlignment(Element.ALIGN_CENTER);
    table.addCell(c1);
    table.setHeaderRows(1);

    table.addCell(getStart());
    table.addCell(getZiel());
    table.addCell(getFlugdatum());
    table.addCell(getFlugdatumEnde());
	...
	private void addRechnung(Document document)
      throws DocumentException {
    Paragraph preface = new Paragraph();
    // We add one empty line
    addEmptyLine(preface, 1);
    // Lets write a big header
    preface.add(new Paragraph("Rechnung", catFont));
    ...
    preface.add(new Paragraph("Rechnung erzeugt von: " + System.getProperty("user.name") + ", am " + new Date(), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        smallBold));
    addEmptyLine(preface, 2);
    preface.add(new Paragraph("Dies ist die Rechnung für "+ getName1()+ " "+ getName2() + " mit der Auftragsnummer " + getNummer(),
        smallBold));
    ...
    document.newPage();
	 ...
	 private void addAuftragsbestaetigung(Document document)
      throws DocumentException {
    Paragraph preface = new Paragraph();
    // We add one empty line
    addEmptyLine(preface, 1);
    // Lets write a big header
    preface.add(new Paragraph("Auftragsbestätigung", catFont));

    addEmptyLine(preface, 1);
    // Will create: Report generated by: _name, _date
    preface.add(new Paragraph("Auftragsbestätigung erzeugt von: " + System.getProperty("user.name") + ", am " + new Date(), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        smallBold));
    addEmptyLine(preface, 2);
    preface.add(new Paragraph("Dies ist die Auftragsbestätigung für "+ getName1()+ " "+ getName2() + " mit der Auftragsnummer " + getNummer(),
        smallBold));
  ...
  private void addContent(Document document) throws DocumentException {
    ...
    addEmptyLine(preface, 1);
    // Lets write a big header
    preface.add(new Paragraph("Weitere Informationen:", catFont));
		document.add(preface);
  ...
  private void createTable(Section subCatPart)
    ...
    // Lets write a big header
    preface1.add(new Paragraph("Auftragsbestätigung", catFont));
		subCatPart.add(preface1);
