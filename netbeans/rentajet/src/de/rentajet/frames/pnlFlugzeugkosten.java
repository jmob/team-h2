...
public class pnlFlugzeugkosten extends javax.swing.JPanel {
	FlugzeugkostenInfo main = new FlugzeugkostenInfo();
  ...
  private void jButton27ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton27ActionPerformed
	...
	private void setzeAnzeige() {
		...
		setFixkosten( main.getdFixkosten() );
		setRentabilitaetStd( main.getiRentabilitaetStd() );
		setFixkostenStd( main.getdFixkostenStd() );
		setStundensatz( main.getdStundensatz() );
		setFlugzeugtypnummer( main.getiFlugzeugtypnummer() );
	...
	private void ermittleKostenFix() {
		if( getFixkosten().isEmpty() || getRentabilitaetStd().isEmpty() ) {
			...
			setFixkostenStd( 
				Util.statischStringNachDouble( getFixkosten(), 2 ) / 
				Util.statischStringNachDouble( getRentabilitaetStd(), 2 ) );
	}
